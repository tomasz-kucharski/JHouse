 ...
 *    28 Jan 2011
 */
public class MQTTService extends RoboService implements MqttSimpleCallback {
   public static final String LOG = MQTTService.class.getName();
    ...
    @InjectPreference("mqtt.hostName")
...
//        mqttServerAddress = settings.getString("mqtt.hostName", "");
//        topicName      = settings.getString("mqtt.topic",  "");
        Log.i(LOG,"Loading preferences. HOST:"+ mqttServerAddress + ", TOPIC:"+topicName);
        ...
        defineConnectionToBroker(mqttServerAddress);
    }
...
//    }
    ...
    synchronized void handleStart(Intent intent, int startId)
    {
        ...
        Log.i(LOG,"cm.getBackgroundDataSetting()="+cm.getBackgroundDataSetting());
    ...
    {
        Log.i(LOG,"NOTIFICATION:"+alert+", title:"+title+", body:"+body);
        NotificationManager nm = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);
        Notification notification = new Notification(R.drawable.ic_statusbar, alert,
                                                     System.currentTimeMillis());
